 ...
 * 修改备注：
 */
public class NeworhotRecyclerviewAdapter extends BaseRecyclerAdapter<Goods> {
    private Context mcontext;
    private int win_width;
    public NeworhotRecyclerviewAdapter(ArrayList<Goods> img_list,int win_width) {
    ...
    public ViewHolder onCreate(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mcontext).inflate(R.layout.layout_neworhot_recyclerview_item, null);
    ...
    class Holder extends BaseRecyclerAdapter.Holder {
        ...
        public Holder(View itemView) {
            super(itemView);
            img = (ImageView) itemView.findViewById(R.id.neworhot_recycleview_img_id);
            craftsmen_img = (RoundImageView) itemView.findViewById(R.id.neworhot_recycleview_craftsmen_img_id);
            craftsmen_rated = (ImageView) itemView.findViewById(R.id.neworhot_recycleview_craftsmen_rated_id);
            name = (TextView) itemView.findViewById(R.id.neworhot_recycleview_name_id);
            price = (TextView) itemView.findViewById(R.id.neworhot_recycleview_price_id);
            like = (TextView) itemView.findViewById(R.id.neworhot_recycleview_like_id);
            craftsmen_name = (TextView) itemView.findViewById(R.id.neworhot_recycleview_craftsmen_name_id);
