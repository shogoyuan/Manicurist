...
public class ExpandableTextView extends TextView implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = mContext.getResources().getDrawable(R.mipmap.ic_bangumi_detail_open);
        }

        if (mCollapseDrawable == null) {
            mCollapseDrawable = mContext.getResources().getDrawable(R.mipmap.ic_bangumi_detail_close);
        }
        typedArray.recycle();
